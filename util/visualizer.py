...
def save_images2(webpage, visuals, image_path, aspect_ratio=1.0, width=256):
    ...
    This function will save images stored in 'visuals' to the HTML file specified by 'webpage'.
    """
    # image_dir = '/mnt/data/jywu/dataset/trainingData_detection/results'
    image_dir = '/mnt/data/jywu/code/cut_unify/contrastive-unpaired-translation-master/results/0717_aoba'
    short_path = ntpath.basename(image_path[0])
    name = os.path.splitext(short_path)[0]
